...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-white shadow-apple border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-2">
            <MapPin className="h-8 w-8 text-primary" />
            <span className="text-xl font-semibold text-text-primary">TripPlanner</span>
          </Link>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              {isNotificationsOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-apple-lg border border-gray-100 py-2 z-50 max-h-96 overflow-y-auto">
                  ...
                  {!userInvitations || userInvitations.length === 0 ? (
                    ...
                    <div className="space-y-1">
                      {userInvitations.map((invitation) => (
                        <div key={invitation.id} className="px-4 py-3 hover:bg-secondary transition-colors">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-2 p-2 rounded-lg hover:bg-secondary transition-colors duration-200"
              >
              ...
              {/* Profile Dropdown */}
              {isProfileMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-apple-lg border border-gray-100 py-2 z-50">
                  <Link
                    to="/profile"
                    className="flex items-center space-x-2 px-4 py-2 text-text-primary hover:bg-secondary transition-colors duration-200"
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 w-full px-4 py-2 text-text-primary hover:bg-secondary transition-colors duration-200"
                  >
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-100">
            <div className="flex flex-col space-y-2">
              <Link
                to="/dashboard"
                className="px-4 py-2 text-text-primary hover:bg-secondary rounded-lg transition-colors duration-200"
